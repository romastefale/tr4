...
ACTION_CATALOG: tuple[dict[str, object], ...] = (
    ...
    {"codigo": "reacoes.reactor.silenciar", "nome": "Silenciar reactor", "categoria": "Reações", "direitos": ("can_restrict_members",)},
    ...
    {"codigo": "radio.agendar", "nome": "Agendar Radio", "categoria": "Radio", "direitos": ()},
    {"codigo": "radio.quiet", "nome": "Silêncio operacional do Radio", "categoria": "Radio", "direitos": (), "critico": True},
    {"codigo": "radio.broadcast", "nome": "Broadcast multi-grupo", "categoria": "Radio", "direitos": (), "critico": True},
