...
_KIND_LOADING = {
    ...
    "week": "Gerando extrato da semana...",
    "month": "Gerando extrato mensal...",
...
async def _render_playing(item: _PendingInline) -> _InlineRender:
    ...
    if not track:
        text = "Não encontrei música atual. Tente novamente em alguns instantes."
        return _InlineRender(caption=text, fallback_text=text)
...
async def _render_tly(item: _PendingInline) -> _InlineRender:
    ...
    if not track:
        text = "Não encontrei essa música." if item.arg else "Não encontrei música atual. Tente novamente em alguns instantes."
        return _InlineRender(caption=text, fallback_text=text)
