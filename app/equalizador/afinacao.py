...
_CANAL_RULES: tuple[dict[str, object], ...] = (
    ...
    {"codigo": "ddx.temporario", "nome": "DDX 10 minutos (legado)", "direitos": ("can_delete_messages",)},
    ...
    {
        "codigo": "convites.editar",
        "nome": "Editar convites",
        "direitos": ("can_invite_users",),
    },
    {
        "codigo": "convites.revogar",
        "nome": "Revogar convites",
        "direitos": ("can_invite_users",),
    },
    {
        "codigo": "entradas.ver",
        "nome": "Ver pedidos de entrada",
        "direitos": ("can_invite_users",),
    },
    {
        "codigo": "entradas.aprovar",
        "nome": "Aprovar pedidos de entrada",
        "direitos": ("can_invite_users",),
    },
    {
        "codigo": "entradas.recusar",
        "nome": "Recusar pedidos de entrada",
        "direitos": ("can_invite_users",),
    },
    {"codigo": "reacoes.recentes.limpar", "nome": "Limpar reações recentes", "direitos": ("can_delete_messages",)},
    {"codigo": "canais_remetentes.banir", "nome": "Banir canal remetente", "direitos": ("can_restrict_members",)},
    {"codigo": "canais_remetentes.liberar", "nome": "Liberar canal remetente", "direitos": ("can_restrict_members",)},
    {"codigo": "membros.tag.definir", "nome": "Definir tag de membro", "direitos": ("can_manage_tags",)},
    {"codigo": "topicos.criar", "nome": "Criar tópicos", "direitos": ("can_manage_topics",)},
    {"codigo": "topicos.editar", "nome": "Editar tópicos", "direitos": ("can_manage_topics",)},
    {"codigo": "topicos.fechar", "nome": "Fechar tópicos", "direitos": ("can_manage_topics",)},
    {"codigo": "topicos.reabrir", "nome": "Reabrir tópicos", "direitos": ("can_manage_topics",)},
    {"codigo": "topicos.apagar", "nome": "Apagar tópicos", "direitos": ("can_delete_messages",)},
    {"codigo": "topicos.desfixar", "nome": "Remover fixados de tópicos", "direitos": ("can_pin_messages",)},
    {"codigo": "topicos.geral.fechar", "nome": "Fechar tópico geral", "direitos": ("can_manage_topics",)},
    {"codigo": "topicos.geral.reabrir", "nome": "Reabrir tópico geral", "direitos": ("can_manage_topics",)},
    {"codigo": "topicos.geral.ocultar", "nome": "Ocultar tópico geral", "direitos": ("can_manage_topics",)},
    {"codigo": "topicos.geral.exibir", "nome": "Exibir tópico geral", "direitos": ("can_manage_topics",)},
    ...
    {
        "codigo": "silencio.ativar",
        "nome": "Ativar modo silêncio",
        "direitos": ("can_restrict_members",),
        "critico": True,
    },
    {
