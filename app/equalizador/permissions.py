...
CANAL_DEFINITIONS: tuple[CanalDefinition, ...] = (
    ...
    CanalDefinition("convites.ver", "Ver convites"),
    CanalDefinition("convites.editar", "Editar convites"),
    CanalDefinition("convites.revogar", "Revogar convites"),
    CanalDefinition("entradas.ver", "Ver pedidos de entrada"),
    CanalDefinition("entradas.aprovar", "Aprovar pedidos de entrada"),
    CanalDefinition("entradas.recusar", "Recusar pedidos de entrada"),
    CanalDefinition("reacoes.recentes.limpar", "Limpar reações recentes"),
    CanalDefinition("reacoes.reactor.silenciar", "Silenciar reactor"),
    CanalDefinition("canais_remetentes.banir", "Banir canal remetente"),
    CanalDefinition("canais_remetentes.liberar", "Liberar canal remetente"),
    CanalDefinition("membros.tag.definir", "Definir tag de membro"),
    CanalDefinition("topicos.criar", "Criar tópicos"),
    CanalDefinition("topicos.editar", "Editar tópicos"),
    CanalDefinition("topicos.fechar", "Fechar tópicos"),
    CanalDefinition("topicos.reabrir", "Reabrir tópicos"),
    CanalDefinition("topicos.apagar", "Apagar tópicos"),
    CanalDefinition("topicos.desfixar", "Remover fixados de tópicos"),
    CanalDefinition("topicos.geral.fechar", "Fechar tópico geral"),
    CanalDefinition("topicos.geral.reabrir", "Reabrir tópico geral"),
    CanalDefinition("topicos.geral.ocultar", "Ocultar tópico geral"),
    CanalDefinition("topicos.geral.exibir", "Exibir tópico geral"),
    CanalDefinition("topicos.geral.desfixar", "Remover fixados do tópico geral"),
    CanalDefinition("grupo.titulo", "Alterar título do grupo", critico=True),
    CanalDefinition("grupo.descricao", "Alterar descrição do grupo", critico=True),
    CanalDefinition("grupo.foto", "Trocar foto do grupo", critico=True),
    CanalDefinition("grupo.foto.remover", "Remover foto do grupo", critico=True),
    CanalDefinition("admins.promover", "Promover administrador", critico=True),
    CanalDefinition("admins.rebaixar", "Rebaixar administrador", critico=True),
    CanalDefinition("admins.titulo", "Título personalizado de administrador", critico=True),
    ...
    CanalDefinition("radio.agendar", "Agendar publicações do Radio"),
    CanalDefinition("radio.quiet", "Configurar silêncio do Radio", critico=True),
    CanalDefinition("radio.broadcast", "Broadcast multi-grupo do Radio", critico=True),
    CanalDefinition("ddx.imediato", "Gerenciar DDX imediato"),
    CanalDefinition("ddx.temporario", "Gerenciar DDX 10 minutos (legado)"),
    CanalDefinition("novos.ver", "Ver monitor de novos membros"),
    CanalDefinition("novos.apagar", "Apagar mensagem de novo membro"),
    CanalDefinition("novos.silenciar", "Silenciar novo membro"),
    CanalDefinition("novos.banir", "Banir novo membro"),
    CanalDefinition("novos.ignorar", "Ignorar alerta de novo membro"),
    CanalDefinition("seguranca.ver", "Ver segurança avançada", critico=True),
    CanalDefinition("seguranca.modo", "Alterar modo de segurança", critico=True),
    CanalDefinition("seguranca.exportar", "Exportar auditoria de segurança", critico=True),
    CanalDefinition("seguranca.limpar", "Limpar auditoria de segurança", critico=True),
    CanalDefinition("seguranca.sessoes", "Diagnosticar sessões e locks", critico=True),
)
