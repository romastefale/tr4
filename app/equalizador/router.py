  ...
  <main class="phone">
    ...
    <section id="publishPanel" class="publish-panel hidden" aria-label="Publicação em grupo">
      ...
      <div class="group-compact">
        ...
        <div class="group-info"><strong id="selectedGroupTitle">Escolha um grupo</strong><span id="selectedGroupHint">Usado apenas quando a função postar no grupo.</span></div>
...
(function(){
  ...
  function groupInitial(group){const title=safeText((group||{}).title||(group||{}).username||"G").trim();return (title.charAt(0)||"G").toUpperCase();}
