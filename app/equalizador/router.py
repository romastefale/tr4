...
(function(){
  ...
  function setSelectedGroup(ref){selectedGroup=ref||"";let group=currentGroups.find(function(g){return g.ref===selectedGroup;});$("selectedGroupTitle").textContent=group?group.title:"Escolha um grupo";$("selectedGroupHint").textContent=group?"Selecionado":"Toque em um grupo abaixo e confirme.";renderSelectedGroupPhoto(group);renderGroups();}
