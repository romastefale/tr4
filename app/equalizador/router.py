...
.group-compact .group-info,
.group-info {
  min-width: 0;
  overflow: hidden;
}

.group-compact strong,
.group-compact span,
.group-info strong,
.group-info span {
  white-space: nowrap;
