...
TR4_FSM_X9_CAPTURE_UNKNOWN_GROUPS = _equalizador_bool_env("TR4_FSM_X9_CAPTURE_UNKNOWN_GROUPS", False)
TR4_FSM_X9_MESSAGE_TTL_SECONDS = _equalizador_int_env("TR4_FSM_X9_MESSAGE_TTL_SECONDS", 46 * 60 * 60)
TR4_FSM_X9_MAX_MESSAGES_PER_GROUP = _equalizador_int_env("TR4_FSM_X9_MAX_MESSAGES_PER_GROUP", 200)
TR4_FSM_X9_SUMMARY_MAX_CHARS = _equalizador_int_env("TR4_FSM_X9_SUMMARY_MAX_CHARS", 80)
